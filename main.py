from config_utils import start_config_and_health_watcher
from sensor import read_environment
from sync import sync_reading
from time import sleep
from device import load_runtime_config, get_runtime_config
...
start_config_and_health_watcher(DEVICE_ID, 300, 300) # Sync config with remote every 5 mins
